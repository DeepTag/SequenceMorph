...
# # --------------------------------------------------------------------------------------------
#
def load_np_mask_array_from_npz0(npz_file):
    npz = np.load(npz_file)
    np_arrs = []
    for np_file in npz.keys(): np_arrs.append(npz[np_file])
    A = np_arrs[0]
...
if __name__ == '__main__':
    ...
    project_data_config_files ='/ailab/data/cardiac_ME/val1/Cardiac_ME_val_config.json'
    data_type = 'validation'
    model_root = '/ailab/data/cardiac_ME/val1/'
